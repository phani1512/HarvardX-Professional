---
title: "Credit Card Fraud Detection Capstone Project - Code"
...
The GBM performance are really good: with an AUC of **0.95** and AUCPR of **0.94**, It doesn't achieve the target for a breath. As the Random Forest model shows, the **V17** is still relevant to predict a fraud.
